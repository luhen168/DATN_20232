...
public class LoggingActivity extends AppCompatActivity {
    ...
    private void startGnssService() {
        if(!isLogging) {
            ...
            isLogging = true;
            Toast.makeText(LoggingActivity.this, "GNSS Service started", Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(LoggingActivity.this, "Logging", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void stopGnssService() {
        if(isLogging) {
            ...
            closeCsvWriter();
            isLogging = false;
            Toast.makeText(LoggingActivity.this, "GNSS Service stopped", Toast.LENGTH_SHORT).show();
        }
        else {
            Toast.makeText(LoggingActivity.this, "Not logging", Toast.LENGTH_SHORT).show();
        }
    }
